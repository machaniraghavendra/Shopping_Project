...
public class PdfGeneratorServiceImpl implements PdfGeneratorService {
     ...
     @Override
     public void generatePdfForOrder(HttpServletResponse response, OrdersDto ordersDto, OrdersEntity ordersEntity,
                                     String totalAmount) throws DocumentException {
          if (Objects.nonNull(ordersEntity) && Objects.nonNull(ordersDto)) {
               try {
                    ...
                    table.addCell(Objects.equals(ordersDto.getEmailAddress(), "") ? "---" : ordersDto.getEmailAddress());
                    ...
                    if (Objects.equals(totalAmount, "") || totalAmount == null) {
