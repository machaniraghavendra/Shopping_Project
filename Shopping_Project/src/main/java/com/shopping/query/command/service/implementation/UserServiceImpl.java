...
import com.shopping.query.command.configuration.jwt.JwtService;
...
//                    return jwtService.generateToken(getUserDetails(userEntity));
               }
...
//          var encryptedUserEmail = encrypt(userName);
//          var user = userRepo.findByUserEmail(encryptedUserEmail).orElseThrow(() -> new UsernameNotFoundException("Not found user"));
//          return Optional.of(getUserDetails(user));
//     }
//
//     @Override
//     public String userAuthenticate(String userEmail, String password) {
//          var encryptedUserEmail = encrypt(userEmail);
//          authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(encryptedUserEmail, password));
//          var user = userRepo.findByUserEmail(encryptedUserEmail).orElseThrow(() -> new UsernameNotFoundException("User not found"));
//          return jwtService.generateToken(getUserDetails(user));
//     }
//
...
//                    return List.of(new SimpleGrantedAuthority(user.isAdmin() ? "ADMIN" : "USER"));
//               }
//
//               @Override
