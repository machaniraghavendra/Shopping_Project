...
export default function Headfones() {
  ...
  const [headfones, setheadfones] = useState([]);
  ...
  return (
    <div className='container-fluid'>
      <h2 id='Headfones' className='dark'>Headfones  <i className="fa-solid fa-headphones" style={{ fontFamily: "fontAwesome" }}></i></h2>
      {fetchDone ?
        headfones.length == [] || !headfones.map(e => { e.itemType.toLowerCase().includes("headfones".toLowerCase()) }) ?
          <div className='container-fluid justify-content-center text-center'>
            <h1>No Items Found !</h1>
          </div>
          :
          <div className='container-fluid justify-content-center text-center' id="back-card-bg-headfones">
            <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 gap-4 justify-content-center text-center">
              {headfones.map(e => {
                if (e.itemType.toLowerCase().includes("headfones".toLowerCase())) {
                  i++;
                  if (i <= 4) {
                    return (
            ...
            <Link className='btn btn-info' to={'/viewmore/headfones'}>View More Headfones....</Link><br></br>
            &nbsp;
          </div>
        :
